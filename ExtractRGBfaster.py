...
with open('OneDrive/Documentos/Verano2024/IntelligentAgents/Proyect/histogramas.txt', 'a') as archivo:
    ...
    for index, row in df.iterrows():
        ...
        # Load the image
        img = io.imread("OneDrive/Documentos/Verano2024/IntelligentAgents/archive/all_images/{}.jpg".format(image_file_name))
...
np.save('OneDrive/Documentos/Verano2024/IntelligentAgents/Proyect/histograma_data.npy', histograms_array)
